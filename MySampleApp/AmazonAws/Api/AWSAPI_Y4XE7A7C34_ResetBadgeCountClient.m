...
@interface AWSAPI_Y4XE7A7C34_ResetBadgeCountClient()
...
@implementation AWSAPI_Y4XE7A7C34_ResetBadgeCountClient

static NSString *const AWSInfoClientKey = @"AWSAPI_Y4XE7A7C34_ResetBadgeCountClient";
...
+ (instancetype)defaultClient {
    ...
    static AWSAPI_Y4XE7A7C34_ResetBadgeCountClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[AWSAPI_Y4XE7A7C34_ResetBadgeCountClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[AWSAPI_Y4XE7A7C34_ResetBadgeCountClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}

+ (instancetype)clientForKey:(NSString *)key {
    @synchronized(self) {
        AWSAPI_Y4XE7A7C34_ResetBadgeCountClient *serviceClient = [_serviceClients objectForKey:key];
        if (serviceClient) {
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://y4xe7a7c34.execute-api.us-west-1.amazonaws.com/beta";
...
- (AWSTask *)rootPost {
    ...
    return [self invokeHTTPRequest:@"POST"
                  ...
                  headerParameters:headerParameters
                              body:nil
                     responseClass:[AWSAPI_Y4XE7A7C34_Empty class]];
}
