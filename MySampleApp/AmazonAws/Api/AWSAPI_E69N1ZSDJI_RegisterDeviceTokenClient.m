...
@interface AWSAPI_E69N1ZSDJI_RegisterDeviceTokenClient()
...
@implementation AWSAPI_E69N1ZSDJI_RegisterDeviceTokenClient

static NSString *const AWSInfoClientKey = @"AWSAPI_E69N1ZSDJI_RegisterDeviceTokenClient";
...
+ (instancetype)defaultClient {
    ...
    static AWSAPI_E69N1ZSDJI_RegisterDeviceTokenClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[AWSAPI_E69N1ZSDJI_RegisterDeviceTokenClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[AWSAPI_E69N1ZSDJI_RegisterDeviceTokenClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}

+ (instancetype)clientForKey:(NSString *)key {
    @synchronized(self) {
        AWSAPI_E69N1ZSDJI_RegisterDeviceTokenClient *serviceClient = [_serviceClients objectForKey:key];
        if (serviceClient) {
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://e69n1zsdji.execute-api.us-west-1.amazonaws.com/beta";
...
- (AWSTask *)rootPost {
    ...
    return [self invokeHTTPRequest:@"POST"
                  ...
                  headerParameters:headerParameters
                              body:nil
                     responseClass:[AWSAPI_E69N1ZSDJI_Empty class]];
}
