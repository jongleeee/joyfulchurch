...
@interface AWSAPI_AD8JYGQVC1_CreateAnnouncementMobileHubClient()
...
@implementation AWSAPI_AD8JYGQVC1_CreateAnnouncementMobileHubClient

static NSString *const AWSInfoClientKey = @"AWSAPI_AD8JYGQVC1_CreateAnnouncementMobileHubClient";
...
+ (instancetype)defaultClient {
    ...
    static AWSAPI_AD8JYGQVC1_CreateAnnouncementMobileHubClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[AWSAPI_AD8JYGQVC1_CreateAnnouncementMobileHubClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[AWSAPI_AD8JYGQVC1_CreateAnnouncementMobileHubClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}

+ (instancetype)clientForKey:(NSString *)key {
    @synchronized(self) {
        AWSAPI_AD8JYGQVC1_CreateAnnouncementMobileHubClient *serviceClient = [_serviceClients objectForKey:key];
        if (serviceClient) {
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://ad8jygqvc1.execute-api.us-west-1.amazonaws.com/Development";
