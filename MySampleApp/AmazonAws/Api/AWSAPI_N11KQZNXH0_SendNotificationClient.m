...
@interface AWSAPI_N11KQZNXH0_SendNotificationClient()
...
@implementation AWSAPI_N11KQZNXH0_SendNotificationClient

static NSString *const AWSInfoClientKey = @"AWSAPI_N11KQZNXH0_SendNotificationClient";
...
+ (instancetype)defaultClient {
    ...
    static AWSAPI_N11KQZNXH0_SendNotificationClient *_defaultClient = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _defaultClient = [[AWSAPI_N11KQZNXH0_SendNotificationClient alloc] initWithConfiguration:serviceConfiguration];
    });
...
+ (void)registerClientWithConfiguration:(AWSServiceConfiguration *)configuration forKey:(NSString *)key {
    ...
    [_serviceClients setObject:[[AWSAPI_N11KQZNXH0_SendNotificationClient alloc] initWithConfiguration:configuration]
                        forKey:key];
}

+ (instancetype)clientForKey:(NSString *)key {
    @synchronized(self) {
        AWSAPI_N11KQZNXH0_SendNotificationClient *serviceClient = [_serviceClients objectForKey:key];
        if (serviceClient) {
...
- (instancetype)initWithConfiguration:(AWSServiceConfiguration *)configuration {
    if (self = [super init]) {
        ...
        NSString *URLString = @"https://n11kqznxh0.execute-api.us-west-1.amazonaws.com/beta";
...
- (AWSTask *)rootPost {
    ...
    return [self invokeHTTPRequest:@"POST"
                  ...
                  headerParameters:headerParameters
                              body:nil
                     responseClass:[AWSAPI_N11KQZNXH0_Empty class]];
}
